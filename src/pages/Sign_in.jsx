                    ...
                    <div className="w-full h-100">
                        ...
                        <form className="mt-6" action="#" method="POST">
                            ...
                            <div className="text-left mt-5">
                                <Link to="/mot_de_passe_oublie" className="text-lg font-bold text-primary focus:text-bggray">Mot de passe oublié?</Link>
                            </div>

                            <LoginButton label="Se Connecter" handleClick={() => { navigate('/') }} />
                        </form>
