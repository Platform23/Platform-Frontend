...
const ProfileCard = ({ userId, viewingOtherProfile}) => {
    ...
    console.log(userId);
    console.log(viewingOtherProfile);
    ...
    return (
        <div>
            <div className="flex flex-wrap justify-center mb-20">
                ...
                {!viewingOtherProfile && (
                    <div className="w-full lg:w-1/9 lg:order-3 lg:text-right lg:self-center">
                        <div className="pt-6 -pb-6 px-3 mt-32 sm:mt-0">
                            <button
                                onClick={handleOpen}
