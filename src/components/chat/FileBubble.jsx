...
const FileBubble = ({ sender, time, fileName, fileSize, fileType }) => {
    ...
    return (
        <div className={`flex ${alignmentClass} gap-2.5`}>
            ...
            <button
                className={`${sender.name === 'Alice' ? 'block' : 'hidden'} inline-flex self-center items-center p-2 text-sm font-medium text-center text-primary bg-white rounded-lg hover:bg-gray-100 focus:ring-1 focus:outline-none focus:ring-gray-50`}
                type="button"
